...
def _full_manifest() -> dict:
    ...
    Note: top-level tracing_table is not included because the new wire format (tracing.enabled)
    cannot express table information, so the round-trip would lose it.
    """
    return {
        "default_agent": "claude",
        "enabled_agents": {
